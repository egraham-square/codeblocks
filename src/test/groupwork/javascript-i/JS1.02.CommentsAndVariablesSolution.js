...
Note:
- For readability, you can use an underscore like you would a comma for large numbers
- e.g. 1000 can be written as 1_000 without affecting the behavior of the code
- more info: https://suprabhasupi.medium.com/numeric-separators-in-javascript-21873dbc0ea
*/
var cityPopulation
cityPopulation = 510823;
...
southDakotaFounded = northDakotaFounded;
montanaFounded = northDakotaFounded;
washingtonFounded = northDakotaFounded;
...
losAngelesState = sacramentoState;
sanFranciscoState = sacramentoState;
