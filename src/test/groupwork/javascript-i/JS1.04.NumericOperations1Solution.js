...
const TOTAL_EARS = NUMBER_RABBITS * EARS_PER_RABBIT
...
const TOTAL_LEGS = NUMBER_DOGS * LEGS_PER_DOG - 1;
...
*/
const NUMBER_SHARKS = 15;
const TEETH_PER_SHARK = 260;

const TOTAL_TEETH = NUMBER_SHARKS * TEETH_PER_SHARK + 130;
...
*/
const NUMBER_PANDAS = 27;
const PANDAS_PER_HAMMOCK = 3;

const HAMMOCKS_TO_BUY = NUMBER_PANDAS / PANDAS_PER_HAMMOCK;
...
*/
const NUMBER_RACOONS = 12
const BANANAS_PER_RACOON = 2
const BANANAS_TO_BUY = NUMBER_RACOONS * BANANAS_PER_RACOON + 1
...
const GREAT_DECIMAL = (3.1 + 1.3) / 2.2;
