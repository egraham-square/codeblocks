...
*/
const GREEN_LENGTH = "green".length
...
*/
const YELLOW_LENGTH = "yellow".length;
...
*/
const ORANGE_LENGTH = "orange".length;
...
const PURPLE_LENGTH = PURPLE_COLOR.length;
...
const BROWN_LENGTH = BROWN_COLOR.length;
...
const BLUE_LETTER = BLUE_COLOR[2];
...
const PINK_LETTER = PINK_COLOR[3];
...
const TEAL_LETTER = TEAL_COLOR[3];
...
const INDIGO_INDEX = INDIGO_COLOR.length - 1;
...
const BERGUNDY_LETTER = BERGUNDY_COLOR[BERGUNDY_COLOR.length - 1];
...
const TURQUOISE_COLOR = "turquoise";
const TURQUOISE_LETTER =  TURQUOISE_COLOR[TURQUOISE_COLOR.length - 2];
...
- We've added the "c" so far. Can you append the remaining letters? (use compound assignment, not concatenation!)
...
programName += GOLD_COLOR[3];
programName += SKY_BLUE_COLOR[SKY_BLUE_COLOR.length - 1];
programName += SKY_BLUE_COLOR[4];
programName += SKY_BLUE_COLOR[5];
programName += GOLD_COLOR[1];
programName += PEACH_COLOR[3];
programName += SKY_BLUE_COLOR[1];
programName += SKY_BLUE_COLOR[0];
...
let orgName = SILVER_COLOR[0] + AQUAMARINE_COLOR[1] + AQUAMARINE_COLOR[2] + AQUAMARINE_COLOR[3] + AQUAMARINE_COLOR[6] + AQUAMARINE_COLOR[AQUAMARINE_COLOR.length - 1];
...
const LAVENDER_INDEX = LAVENDER_COLOR.length - 4;
